**Writing Under Surveillance: The Problems with AI Detection**
...
Call it the police state of writing, one where students answer to the verdicts of unvetted software that is, for all intents and purposes, easy to game. Running synthetic text through a paraphrasing tool, for example, dropped DetectGPT's accuracy from 70.3% to 4.6% without changing meaning (Krishna et al.). Better yet, randomly inserting the word "cheeky" fooled detectors 80–90% of the time ("AI Detection Tools," USD Law Library). In such cases, we are invited to consider why our institutions keep insisting, if not pretending, that AI detection works in the first place?
...
For educators, the real work begins in and around classrooms, where we read each other's work with care, respond to it honestly, and remind ourselves that learning is messier in practice than any set of algorithms can name. AI detection software forecloses that work, recasting teachers as auditors and their students as suspects, while undermining the conditions under which young writers practice their writing. But trust can be rebuilt, and it often starts with the slow, everyday practice of reading and writing together again.
