...
The intervention proved durable enough to move from educational psychology to computational laboratories, where the same occlusion premise became the supervisory signal for training masked language models to infer missing words from surrounding text at scale.
