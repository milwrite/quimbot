...
I trace the cloze procedure's arc from early reading comprehension assessment through masked language model pretraining to show what Cloze Reader's design inherits from each history and what it deliberately holds apart.
