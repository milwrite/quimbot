...
The intervention proved durable enough to migrate from educational psychology into computational laboratories. Machine learning researchers, working from different disciplinary starting points, recognized the same core premise, namely, that asking a system to predict a missing word from surrounding context tests whether it has internalized how language works.
