...
*Draft v43 · Updated 2026-03-30 EDT · Style sweep: "simple procedural idea" → "narrowly defined operation"; "formally simple" → "formally minimal"; three "rather than" constructions resolved; consecutive thin independents merged or subordinated in Educational Genealogy and Continuity sections; pseudo-cleft "What Taylor was measuring" → "His measurement also described"; bare "This difficulty/discreteness" → "The difficulty/discreteness"; "not accidental" opener → "runs deeper than analogy"; "is not merely theoretical" → "has empirical support"; "To be clear" opener and fragmented "The purposes differ" resolved; em-dash patch in Devlin sentence replaced with participial*
