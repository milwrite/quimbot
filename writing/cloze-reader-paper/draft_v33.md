...
Cloze Reader addresses this tension structurally. By dividing the cloze task between model and player, separating selection from interpretation, the game holds apart what masked language modeling conflates. The model identifies where context matters. The reader decides what context means. That division stages the asymmetry rather than resolving it: where Taylor's procedure assessed comprehension as a holistic capacity, BERT's objective optimized prediction as a training signal. Cloze Reader makes the gap between those two operations visible through play.
...
*Draft v33 · Updated 2026-03-21 EDT · ~4,000 words · Harris/Firth/Mikolov/Peters/Devlin genealogy expanded and relocated to intro; thesis sentence added; style-guide audit: colons converted to subordinate clauses, abstract-subject stubs folded into researcher subjects*
