...
- **Kalshi config v2** — 5-min scan, 20 bets/day cap, $5/bet, 3 max/run (`528c1d6`) ✅ 3/25
- **creative-clawing: Dadras attractor + Sprott family + KH instability** — 3 new artifacts + mobile fixes on 25 files (`7e73dd9`..`e6a4e09`) ✅ 3/25
...
## 🔨 In Progress
- **creative-clawing gallery** — 91 artifacts, 35 microblogs live; ongoing curation + new drops
- **Cloze reader paper** — v43 current; style sweep + EDITS.md kanban (15 approved v43 edits, 4 proposed); argument fix (pretraining/slow-reading error corrected)
