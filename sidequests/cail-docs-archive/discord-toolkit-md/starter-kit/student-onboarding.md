...
**Source:** https://discordedu.commons.gc.cuny.edu/student-onboarding/  
...
1. Direct student attention to the invite link as the key path to your server

1. Remind students to reach out to you via email if they encounter technical difficulties with installing the app, registering an account, or using the  invite link. 

1. Draw attention to a specific channel that will contain additional directions for when they join your server  
...
![](https://discordedu.commons.gc.cuny.edu/files/2022/01/Screen-Shot-2022-01-19-at-11.18.58-AM-1024x813.png)
