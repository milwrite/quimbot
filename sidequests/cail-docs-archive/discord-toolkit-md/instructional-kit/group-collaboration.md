...
**Source:** https://discordedu.commons.gc.cuny.edu/group-collaboration/  
...
To accommodate group work in your server, you will want to first create group roles that you can later assign to private channels. Follow the steps below to take care of that first process:
 	...
 	1. Name and create each group role
...
Your next step is to assign the above group roles to students in your class. Here’s how: 
 	...
 	1. Click the first group role you want to assign to your students 

 	1. Select **Manage Members**

 	1. Search for and add the students you intend to add that group

 	1. Repeat these steps for each group of students in your class
...
After you create and assign group roles, you can then create private categories and channels for every peer group in your class. Follow these steps to set that up: 
 	...
 	1. Select **Create Category **or **Create Channel**

 	1. Name the category or channel

 	1. Click **Next**

 	1. Select the group role that you want to access the category or channel

 	1. Press **Create Category** or **Create Channel**
...
[**← Return to Class Communication**](https://discordedu.commons.gc.cuny.edu/class-discussion/)**      **[**Continue to the Resources Menu →**](https://discordedu.commons.gc.cuny.edu/resources/)
