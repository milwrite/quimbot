...
**Source:** https://discordedu.commons.gc.cuny.edu/server-customization/  
...
To create new text and voice channels in your server, follow these steps: 
 	...
 	1. Choose between a voice or text channel, then name it accordingly

 	1. Click **Create Channel**, with the privacy option toggled for now. More on that later.

![image](https://lh6.googleusercontent.com/_DgfHxAvOsvfKY5u-pasWNDyzus2-22dqwtV86Kp_29ibVDNJiYfYVy2nbIqRpi7kGbMjGS2y1E5oqGsMdKP1c7rmAtCgrDM_T7O6O_1IiQnc4pV7nnUE3wQ_VwNNADZSMkB7OOR)
...
Next up: complete the tasks below to practice customizing your server with a classroom in mind.
 	...
 	1. Create some channels to be organized under your new category

 	  1. Click the plus sign next to the category

 	  1. Create a series of channel related to course info (e.g. *`#useful-links`, `#syllabus`*)

 	1. Drag and drop channels to foreground important ones at the top

![image](https://lh6.googleusercontent.com/PpLlRmtN9J--3jVJLEVrEf0XaT3fnnyd09pNR9HTUNsn2ePu-mptRpJ5fDhYliykCSuoK8yvY5dqKbZOoim6-dV6k4cFEJL6v8uWlkHsls2-rhnSAuIoLovQX3mhzmcpmFXy_vYc)
...
![image](https://lh5.googleusercontent.com/2ryks4crREhv0oJWtyd8gKGlJAgBW3srtjxbc90DAnrWWDvklECxmbZm-8YEy59kqtWo2OPlgRZ1YOshGvrAf_ZILwHqRlrpK3mnJl6OzbuliIApxIHg3H66TPcomCyAuKcfGj1h)
...
![image](https://lh4.googleusercontent.com/KP17lLbGC1sI2dOaI1HIK6Q91TLJY2jViArRgi1dsjlGqJGgNNoqcK8MFiBL3QW4-co9O3-WNspht9H-KggcMJbS57O0RI3vm6MzclGXLXy2Ldhf8D2w5d_XgmoQqE045SHwPfO4)
...
To animate your teaching persona on Discord, customize your user profile via the steps below:
 	...
 	1. Select** Change Avatar »** upload your favorite prof pic, no pun intended

 	1. Toggle the **About me **to write a few words introducing yourself
...
You can also customize your individual server profile for your class by following the steps below:
 	...
 	1. Toggle the collapsable menu in the top left corner, then click **Edit Server Profile**.

 	1. Customize the title you go by with your students (e.g. Prof. Xavier)
